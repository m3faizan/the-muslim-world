  ...
  return (
    <div className="relative h-screen w-screen bg-background overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-5 py-3 bg-gradient-to-b from-background/90 to-transparent pointer-events-none">
        ...
        <div className="flex items-center gap-2 pointer-events-auto">
          ...
          <button
            ...
            className="p-2 rounded-lg bg-card/90 border border-border text-muted-foreground hover:text-foreground transition-colors backdrop-blur-sm"
          >
            {sidebarOpen ? <X className="w-4 h-4" /> : <Layers className="w-4 h-4" />}
          </button>
        </div>
      </div>
      ...
      <div
        ...
        style={{ width: "272px" }}
      >
        <div className="h-full bg-background/95 border-l border-border backdrop-blur-md flex flex-col overflow-hidden">
          <div className="p-4 pt-14 border-b border-border flex-shrink-0">
